 ...
 *   - "setup"   runs prepare() + warmup BEFORE tracing starts, so neither the setup DOM work nor
 *               warmup iterations inflate the window-scoped counts.
 *   - "timed"   runs the measured iterations, wrapped in wpd:* marks, in one call over the whole
