 ...
 * idle panel); Firefox headless runs ~120Hz (8.3ms).
 */
export const CHROME_HEADLESS_FRAME_FLOOR_MS = 16.6;
export const FIREFOX_FRAME_FLOOR_MS = 8.3;
 ...
 * flaps 120/60Hz run to run (frame-floor.md), so it declares none. Chrome's built-in headless is the
 * single synthetic-60Hz floor; Firefox headless is the single 120Hz floor.
 */
