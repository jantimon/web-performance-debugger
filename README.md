...
<p align="center">
  <img src="https://github.com/user-attachments/assets/REPLACE-ME-logo-chrome" alt="Chrome logo, hand-drawn" height="64">
  <img src="https://github.com/user-attachments/assets/REPLACE-ME-logo-firefox" alt="Firefox logo, hand-drawn" height="64">
  <img src="https://github.com/user-attachments/assets/REPLACE-ME-logo-node" alt="Node.js logo, hand-drawn" height="64">
</p>
...
<img src="https://github.com/user-attachments/assets/REPLACE-ME-logo-chrome" alt="" height="20"> Every `record` invocation is **exactly one capture pass** — one browser launch, one run of the flow.
...
<img src="https://github.com/user-attachments/assets/REPLACE-ME-logo-firefox" alt="" height="20"> On **Firefox** every mode is the same one capture, so the table reports what that capture yields
